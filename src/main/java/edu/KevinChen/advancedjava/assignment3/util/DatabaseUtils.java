package edu.KevinChen.advancedjava.assignment3.util;

import com.ibatis.common.jdbc.ScriptRunner;
import edu.KevinChen.advancedjava.assignment3.services.DatabasePersonService;
...
public class DatabaseUtils {
    ...
    public static Connection getConnection() throws edu.KevinChen.advancedjava.assignment3.util.DatabaseConnectionException {
        Connection connection = null;
        try {
            Class.forName("com.mysql.jdbc.Driver");
            connection =   DriverManager.getConnection(DB_URL, USER, PASS);
        } catch (ClassNotFoundException  | SQLException e)  {
           throw new edu.KevinChen.advancedjava.assignment3.util.DatabaseConnectionException("Could not connection to database." + e.getMessage(), e);
        }
        return connection;
    }
    ...
    public static Connection getOrmConnection() throws DatabaseConnectionException {
        Connection connection = null;
        Configuration configuration = getConfiguration();
        try {
     ...
     * @throws DatabaseInitializationException
     */
    public static void initializeOrmDatabase(String initializationScript) throws DatabaseInitializationException {
