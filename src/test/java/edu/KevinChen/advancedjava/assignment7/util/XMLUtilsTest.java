...
public class XMLUtilsTest {
    ...
    private static String xmlInstance = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            "<stocks>\n" +
    ...
    **/
    ...
    private void validateFamily(Stocks stocks) {
        assertTrue("Father name is correct", stocks.getStock().size() == 49);
    }
